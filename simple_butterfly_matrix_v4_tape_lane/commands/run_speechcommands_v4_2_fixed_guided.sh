...
python simple_butterfly_matrix_v4_tape_lane/tape_lane_transport_v4_2_fixed.py \
  ...
  --log-every 50 \
  --no-save-checkpoints \
  --out-dir simple_butterfly_matrix_v4_tape_lane/runs/speechcommands_5ep_v4_2_fixed_guided
