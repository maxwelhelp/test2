...
def aux_losses_v43(logits: torch.Tensor, baux, haux: Dict[str, torch.Tensor], args) -> Dict[str, torch.Tensor]:
    ...
    out["update_collapse_proxy"] = residual_proxy.detach()
    out["update_collapse_proxy"] = residual_proxy.detach()
    out["residual_dominance_proxy"] = residual_proxy.detach()  # deprecated alias  # deprecated alias  # deprecated alias  # deprecated alias  # deprecated alias  # deprecated alias  # deprecated alias  # deprecated alias  # deprecated alias  # deprecated alias  # deprecated alias  # deprecated alias  # deprecated alias  # deprecated alias
