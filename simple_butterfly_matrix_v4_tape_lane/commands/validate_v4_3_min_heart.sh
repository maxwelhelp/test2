...
grep -q "make_loaders_fast" "$WRAP"
grep -q "evaluate_fast" "$WRAP"
grep -q "persistent_workers" "$WRAP"
grep -q "prefetch_factor" "$WRAP"
grep -q "fast eval computes loss/accuracy" "$WRAP"
